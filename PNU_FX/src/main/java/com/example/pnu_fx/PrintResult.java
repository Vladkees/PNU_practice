...
public class PrintResult {
    ...
    private void compareParagraphs(List<String> firstParagraphs, List<String> secondParagraphs) {
       ...
       showDistanceWindow(info.toString(), paragraphInfos);
    }
    ...
    private void showDistanceWindow(String info, List<String> paragraphInfos) {
        ...
        for (String paragraphInfo : paragraphInfos) {
            ...
            String title = parts[0] + " " + parts[1]; // Заголовок: "Абзац X: Зміни в абзаці: Y"
